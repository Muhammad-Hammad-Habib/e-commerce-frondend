  ...
  return (
    <section id="about" className="w-full second-main-bg py-10 px-3 sm:py-20  ">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12  items-center     sm:px-8  md:px-10">
        {/* --- Left Content --- */}
        <div>
          <h2 className="text-3xl md:text-4xl font-extrabold text-[#2F2119] mb-4">
            About Us
          </h2>

          <p className="text-[#5F4638] leading-relaxed text-lg mb-3 sm:mb-6">
          ...
          <p className="text-[#5F4638] leading-relaxed text-lg">
